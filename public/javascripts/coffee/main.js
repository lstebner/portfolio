...
(function() {
  var EventTracker, Events, Project, ProjectOverlayView, Showcase;
  ...
  */
  ...
  ProjectOverlayView = (function() {
    ...
    ProjectOverlayView.prototype.cycle_images = function(dir) {
      var $viewed, $viewing, next_idx, _ref,
        _this = this;
      if (dir == null) {
        dir = 1;
      }
      ...
      if ((_ref = World.event_tracker) != null) {
        _ref.track_event('user_action', 'click', 'change_image', (dir > 0 ? 'next' : 'prev'));
      }
  ...
  */
  ...
  Showcase = (function() {
    ...
    Showcase.prototype.open_project_overlay = function(for_project) {
      var _ref;
      if ((_ref = World.event_tracker) != null) {
        _ref.track_event('user_action', 'click', 'view_project', for_project);
      }
