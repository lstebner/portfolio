...
(function() {
  var App, Requires, Schema, _, _str, app, expect, process, test_app, test_config, test_mongoose;
  ...
  describe("app/core/App", function() {
    before(function() {
      return app = App.init({
        app: test_app,
    ...
    it("should return http://testingbaseurl.com/ when base_url is called with no parameters", function() {
      return expect(app.base_url(null, true)).to.equal("http://testingbaseurl.com/");
    });
    it("should return http://testingbaseurl.com/hotsauce when base_url is passed a uri", function() {
      return expect(app.base_url("/hotsauce", true)).to.equal("http://testingbaseurl.com/hotsauce");
    });
    it("should return a correct conf value", function() {
      return expect(app.conf("meta_keywords")).to.equal("meta keywords value");
    });
    it("should return false for a conf key that doesn't have a value", function() {
      return expect(app.conf("jibberjabber")).to.equal(false);
    });
    return it("should return false for conf if no key is passed", function() {
